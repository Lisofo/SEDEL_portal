...
class PapDesktop extends StatefulWidget {
  const PapDesktop({super.key});

  @override
  State<PapDesktop> createState() => _PapDesktopState();
}

class _PapDesktopState extends State<PapDesktop> {
  ...
  void getData() async {
    ...
    final categ = 'PAP';
documentos = (await PortalServices().getDocumentos(codCliente, categ, '0'));    if (codCliente == '') {
