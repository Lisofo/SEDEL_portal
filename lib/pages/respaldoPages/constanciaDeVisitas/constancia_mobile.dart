...
class ConstanciaVisitasMobile extends StatefulWidget {
  const ConstanciaVisitasMobile({super.key});

  @override
  State<ConstanciaVisitasMobile> createState() =>
      _ConstanciaVisitasMobileState();
}

class _ConstanciaVisitasMobileState extends State<ConstanciaVisitasMobile> {
