...
class ReportesMobile extends StatefulWidget {
  const ReportesMobile({super.key});

  @override
  State<ReportesMobile> createState() => _ReportesMobileState();
}

class _ReportesMobileState extends State<ReportesMobile> {
